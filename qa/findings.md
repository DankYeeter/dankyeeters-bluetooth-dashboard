...
| F-012 | Statuswechsel: von QA am Geraet bestaetigt behoben (T-050r, `84e576c`) — `media.audio_flinger` stoppt binnen < 8 s nach HOME/Tabwechsel, Lauf zeigt Luecke, 60-s-Grafik uebersteht Drehung; Arm-A-Teil nicht geprueft (Compare verlangt USB ab) | P2 | qa-engineer (T-050r) | – | behoben | 2026-09-23 | T-050 |
| F-014 | AK-4: bei geschlossenem Monitor, Musik spielend, Bildschirm an fragt der Sampler alle 30 s `dumpsys bluetooth_manager` ab (gemessen 22:35–22:38, je 2/min; `SamplingPolicy.kt:33`) — widerspricht dem Wortlaut von AK-4 und leert laut R-011 die BQR-Queue; Bildschirm aus nicht messbar (Kabel haelt wach) | P2 | qa-engineer (T-050r, Geraet) | director → Nutzer | offen | 2026-09-23 | T-050r |
